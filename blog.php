            ...
            <?php foreach ($result as $row) : ?>
                <div id="post-<?php echo $row['id']; ?>" class="card mb-4">
                    ...
                    <?php if ($_SESSION['user_id'] == $row['user_id'] || $_SESSION['role'] === 'admin') : ?>
                        <a href="#deleteModal-<?php echo $row['id']; ?>" class="btn delete-button" data-toggle="modal">Zmazať</a>
                        <a href="#editModal-<?php echo $row['id']; ?>" class="btn button-farba" data-toggle="modal">Upraviť</a>
                    <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="deleteModalLabel">Zmazať príspevok</h5>
                            ...
                            <form method="POST" action="blog.php">
                                <div class="modal-body">
                                    Naozaj chcete zmazať tento príspevok?
                                    <input type="hidden" name="post_id" value="<?php echo $row['id']; ?>">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Zrušiť</button>
                                    <button type="submit" name="delete" class="btn delete-button">Zmazať</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="blog.php" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Zrušiť</button>
                                    <button type="submit" name="edit" class="btn btn-primary">Uložiť zmeny</button>
                                </div>
                            </form>
                        </div>
                    </div>
